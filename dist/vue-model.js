...
var applicators = {
    ...
    with: function _with(data, args) {
        return _.defaultsDeep(_.toPlainObject(args[0]), data);
    },

    without: function without(data, args) {
        if (_.isString(args[0])) {
            args[0] = [args[0]];
        }
    ...
    callback: function callback(data, args) {
...
var DataPipeline = function DataPipeline() {
    var pipeline = [];
    ...
    var api = {
        pipeline: {
            ...
            prependStep: function prependStep(name, args) {
                pipeline.unshift({
                    name: name,
                    args: args
                });
            ...
            appendStep: function appendStep(name, args) {
                pipeline.push({
                    name: name,
                    args: args
                });
 ...
 * @constructor
 */
var Model = function Model(data, settings) {
    var self = this;
...
},{"./DataPipeline":2,"./ModelErrors":5,"lodash":1}],4:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    actions: {
        list: {
            method: 'GET',
            route: '',
            pipeline: function pipeline(DataPipeline) {
                DataPipeline.none();
            }
        },
        create: {
    ...
    validationErrors: {
        ...
        isValidationError: function isValidationError(response) {
...
module.exports = function () {
    var api = {
        ...
        has: function has(field) {
            return _.has(api.all, field) && _.isArray(_.get(api.all, field)) && _.get(api.all, field).length;
        },
        ...
        push: function push(field, value) {
            if (api.has(field)) {
...
(function () {
    ...
    var registerModel = function registerModel(type, options) {
    ...
    var createModel = function createModel(type, data, options) {
        // Vue instance
        var vm = this;
    ...
    var createModels = function createModels(type, datas, options) {
        // Vue instance
        var vm = this;
    ...
    var automaticallyCreateModels = function automaticallyCreateModels() {
        // Vue instance
        var vm = this;
...
},{"./Model":3,"./ModelDefaults":4,"lodash":1}]},{},[6]);

//# sourceMappingURL=vue-model.js.map
